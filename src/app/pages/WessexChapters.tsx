export default function WessexChapters() {
  return (
    <>
      <h2 className="text-3xl mb-6" style={{ fontFamily: "'Cinzel', serif" }}>
        Wessex District Chapters
      </h2>

      <p className="mb-6 leading-relaxed">
        The Wessex District comprises 17 active Chapters meeting throughout Hampshire and the Isle of Wight. Each Chapter maintains the beautiful traditions and ceremonies of the Rose Croix while developing its own unique character and fellowship.
      </p>
      ...
      <section className="mb-10">
        ...
        <p className="mb-4 leading-relaxed">
          To find a Chapter near you or to learn about meeting times and locations, please visit our <a href="/district-chapters" className="text-[#6b1a1a] hover:underline font-semibold">District Chapters</a> page for a complete listing.
        </p>

        <p className="mb-4 leading-relaxed">
          Alternatively, contact the District Recorder who will be happy to recommend a Chapter based on your location and preferences.
        </p>
      </section>
      ...
      <section>
        ...
        <div className="bg-white border-l-4 border-[#6b1a1a] p-6">
          <p className="mb-2">
            <strong>Contact:</strong> Ill. Bro. Colin Brown 33°, District Recorder
          </p>
